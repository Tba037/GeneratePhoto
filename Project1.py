...
st.title("Hai Everyone! made by: T")
...
selectprice = st.selectbox("Select", options=['Harga Under', 'HargaLusin', 'HargaKoli','HargaSpecial'])
...
if start2:
    ...
    with st.spinner("Making Image..."):
        def wrap_text(text, font, max_width):
            ...
            # Perhitungan dengan ukuran karakter 'a'
